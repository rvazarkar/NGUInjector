...
- **Manage Boost Conversion** - If all basic 100 Level Challenges are completed, will calculate needed boosts for items in boostIds and then switch auto conversion appropriately. Will prioritize power > toughness > special. Will also show you the hourly average of boost progress in the inject.log file.
